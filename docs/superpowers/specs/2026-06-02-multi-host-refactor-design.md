...
> **Norfolk:** the hardware recon and design for the second host (norfolk) and the
> `jbosio` user have moved to their own spec:
> `docs/superpowers/specs/2026-06-13-norfolk-host-design.md`. This spec covers only
> the Logan refactor.
